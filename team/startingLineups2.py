...
def getTeamStartingLineups2(teamName, year):
    url = f'https://www.basketball-reference.com/teams/{teamName}/{year}_start.html'
    ...
    div = str(soup.find_all('div',id='all_starting_lineups_summary_po0')[0])
